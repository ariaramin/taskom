...
class AppColors {
  // Primary
  static const Color primaryColor = Color(0xfff5a60d);
  static const Color secondaryColor = Color(0xFFFFEAC0);
  ...
  // Dark
  static const Color backgroundDarkColor = Color(0xFF181A20);
  static const Color primaryContainerDarkColor = Color(0xFF101113);
